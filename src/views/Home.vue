    ...
    <el-card class="box-card bg-gray fix-pos" :body-style="{ padding: '0px' }">
      <div class="block">
        ...
        <div class="fn-block bg-white">
          ...
          <el-card v-for="user in userList" :key="user.name" class="user-item">
        ...
        <div class="fn-block">
          ...
          <el-card v-for="job in jobList" :key="job.neededJob" class="user-item">
        ...
        <div class="fn-block bg-white">
          <div class="title">热门话题<span class="down-line"></span></div>
          <div class="hot-list">
