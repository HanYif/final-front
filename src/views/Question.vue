    ...
    <el-card class="box-card bg-gray fix-pos" :body-style="{ padding: '0px', position: 'relative' }">
      ...
      <div class="aside">
        <div class="hot-ques-container bg-white">
          <h3>热门问题</h3>
          <div class="hot-ques">
            <div v-for="ques in postList" class="hot-ques__item">
              <a href="/" class="ques-title">{{ques.title}}</a>
              <div>
                <span>{{ques.answerCount}}回答</span>
        ...
        <div class="hot-user-container bg-white">
          ...
          <div class="hot-user">
            <div v-for="(user, index) in userList" class="hot-user__item">
              <div class="rank" :class="{'first': index===0, 'second': index===1, 'third': index===2}">{{user.answerRank}}</div>
              <img class="head" :src="user.icon"></img>
              <a class="ques-title" href="/">{{user.name}}</a>
              <div class="user-info">
                <span class="title">{{user.title}}</span>
                <span class="answer-count fl-r">{{user.answerCount}}回答</span>
              </div>
            </div>
          </div>
        </div>
